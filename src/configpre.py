...
def parse_args():
    ...
    parser.add_argument('--val_ratio', default=0.00000001, type=float, help='split 10 percentages of training data as validation')
