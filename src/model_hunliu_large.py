...
class MultiModal(nn.Module):
    ...
    def forward(self, inputs):
        ...
        video_mask2 = torch.cat((video_mask, video_mask[:, 0:1]), dim=1)
        
        Text_features, lm_prediction_scores = self.bert_text(video_feature2, video_mask2, text_input_ids, text_mask, is_usemask=False, return_mlm=return_mlm)
